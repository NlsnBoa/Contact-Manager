...
function doRegister() {
  ...
  if (login.length < 3 || login.length > 18) {
    alert("Error: Invalid username length.");
    return;
  }
  ...
  if (!(numbers.test(password))) {
    alert("Error: Password does not contain a number.");
    return;
  }
  ...
  if (!(letters.test(password))) {
    alert("Error: Password does not contain a letter.");
    return;
  }
  
  // Check if password contains letters
  if (!(specialChars.test(password))) {
    alert("Error: Password does not contain one of the following special characters: !@#$%^&*");
    return;
  }
